...
@section('title', 'Edit Why Direct Deal Section')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Edit Why Direct Deal Section</h4>
    ...
    <form action="{{ route('admin.home-why-sections.update', $section->id) }}" method="POST" class="card shadow-sm">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row g-3">
