...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Edit developer</h4>
    ...
    <form action="{{ route('admin.developers.update', $developer) }}" method="POST" class="card shadow-sm">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" name="name" value="{{ old('name', $developer->name) }}" placeholder="e.g. Emaar Properties" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control {{ $errors->has('logo_text') ? 'is-invalid' : '' }}" id="logo_text" name="logo_text" value="{{ old('logo_text', $developer->logo_text) }}" placeholder="e.g. EMAAR">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control {{ $errors->has('search_slug') ? 'is-invalid' : '' }}" id="search_slug" name="search_slug" value="{{ old('search_slug', $developer->search_slug) }}" placeholder="e.g. Emaar">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control {{ $errors->has('sort_order') ? 'is-invalid' : '' }}" id="sort_order" name="sort_order" value="{{ old('sort_order', $developer->sort_order) }}" min="0">
                ...
                <div class="col-12">
                    <div class="form-check">
                        ...
                        <input type="checkbox" class="form-check-input" id="logo_dark" name="logo_dark" value="1" {{ old('logo_dark', $developer->logo_dark) ? 'checked' : '' }}>
                ...
                <div class="col-12">
                    <div class="form-check">
                        ...
                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $developer->is_active) ? 'checked' : '' }}>
